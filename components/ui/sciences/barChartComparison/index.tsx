...
// Dados
import highlightedColor from "@/data/pallets/highlightedColor.json";
import lightColor from "@/data/pallets/lightColor.json";
...
export default function BarChartComparison<T>({
  data,
  xKey,
  dataKeyOne,
  dataKeyTwo,
    ...
    <ResponsiveContainer width="100%">
      ...
      >
        ...
        <Bar dataKey={dataKeyTwo} name={nameKeyTwo}>
          ...
          {data.map((item, index) => (
            <Cell key={index} fill={lightColor[index % lightColor.length]} />
          ))}
        </Bar>
      </BarChart>
    </ResponsiveContainer>
