...
export default function NotFoundUI({ hrfe }: { hrfe: string }) {
    return (
        <div className="w-full h-screen bg-[#edf3fb] flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
            <div className="w-full lg:w-1/2 p-8 flex flex-col items-center text-center">
                ...
                <motion.h1
                    ...
                    className="mt-2 text-4xl md:text-5xl font-bold text-gray-800 dark:text-gray-200"
                >
                ...
                >
                    Desculpe, mas não encontramos o que você procura.
                </motion.p>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    ...
                    className="mt-8"
                >
                    <Link href={hrfe ? hrfe : '/'} passHref>
                        <div className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white rounded-lg transition">
