...
const NavBar: FunctionComponent<NavBarProps> = ({
  ...
  return (
    <div className="p-4 xl:ml-60 2xl:ml-80">
      <nav className={`block w-full max-w-full ${getColorForRoute()} text-white shadow-none rounded-xl transition-all px-3 py-2 overflow-auto`}>
            ...
            <div className="flex ">
              ...
              <a href="#">
                ...
                >
                  ...
                  <p className="font-sans font-bold center text-white">
                    Login{" "}
                  </p>
                </button>
                <button
