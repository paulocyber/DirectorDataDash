                    ...
                    <div className="flex items-center small-screen:flex-col">
                        ...
                        <div className="flex ">
                            <div className="flex items-center">
                                <button
                                    className="middle  lg:flex hidden  none font-sans font-bold center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30 hidden items-center gap-1 px-4 xl:flex"
                                    type="button"
                                >
                                    <FaUserCircle className="h-5 w-5 text-white" />
                                    <p className="font-sans truncate w-12 font-bold center text-white truncate">{user}</p>
                                </button>

                                <button
                                    onClick={openModal}
                                    className="relative cursor-pointer middle none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs text-white hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30"
                                    type="button"
                                >
                                ...
                                <button
                                    className="relative middle lg:hidden none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs text-white hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30"
                                    type="button"
                                >
                                    <span className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                        <FaUserCircle className="h-5 w-5 text-white" />
