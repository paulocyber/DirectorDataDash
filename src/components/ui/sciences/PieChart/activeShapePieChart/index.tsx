// Bibliotecas
import { Pie, PieChart, ResponsiveContainer, Cell, PieLabelRenderProps, Tooltip, TooltipProps } from "recharts";
...
interface CustomActiveShapePieChartProps<T> {
    ...
    ToolTipComponent?: (props: any) => JSX.Element; // Alteração aqui
...
export const CustomActiveShapePieChart = <T,>({ data, valueKey, displayToolTip, ToolTipComponent, label }: CustomActiveShapePieChartProps<T>) => {
    ...
    return (
        <ResponsiveContainer width="100%" height="100%">
            <PieChart>
            {displayToolTip && ToolTipComponent && <Tooltip content={(props) => <ToolTipComponent {...props} />} />}
                <Pie
