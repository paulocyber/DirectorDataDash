    ...
    <div className="col-span-12 md:pb-0 mb-[4em] w-full">
      <div className="grid gap-1 grid-cols-1 lg:grid-cols-1 px-5">
        <div className="bg-white shadow-lg rounded-xl p-5">
          <div className="md:flex items-center justify-between w-full mb-5">
            <div className="p-1 pb-5">
              <h1 className="font-bold md:text-lg text-sm">Relatório mensal</h1>
            </div>
            <div className="relative flex ">
              <button className="inline-flex mx-8 justify-center items-center w-full md:px-3 px-1 py-1 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500">
              ...
              <button className="inline-flex justify-center items-center w-full md:px-3 px-1 py-1 text-sm font-medium text-white bg-blue-700 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500">
          ...
          <div className="md:flex w-full">
            <TableDavs columns={columns} data={davJson} />
          </div>
        </div>
      </div>
    </div>
...
export default DavsMainContent;
