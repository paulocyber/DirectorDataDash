...
import { renderCell } from "@/components/ui/renderCell/davs/detail/renderCell";
...
// Tipagem
import { ItemsDavData, ProductsDavData } from "@/types/davs/index";
interface LayoutProps {
    listDav: ItemsDavData[];
    products: ProductsDavData[]
    infoCard: { icon: ReactNode; title: string; value: string }[]
}

export default function UiDavDetail({ listDav, products, infoCard }: LayoutProps) {
