            ...
            <div className="mt-5 ">
                <div className="mb-5 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md z-10">
                        <div className="bg-gradient-to-br from-gray-600 to-black mx-4 rounded-xl overflow-hidden text-white shadow-red-500/40 shadow-lg absolute -mt-4 grid md:h-16 h-14 md:w-16 w-14 place-items-center">
