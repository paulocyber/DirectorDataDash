...
const FilterDate: FunctionComponent<DashBoardProps> = ({
  selectedDate,
  setSelectedDate,
}) => {
  return (
        ...
        renderCustomHeader={({ date, decreaseMonth, increaseMonth }: any) => (
          <div className="w-full flex items-center p-2 bg-white rounded-t-lg  border-b-2 border-gray-300">
            <button
              ...
              className="hover:bg-gray-300 transition duration-300 ease-in-out hover:bg-opacity-80 p-[0.2em] rounded-lg"
            >
              <NavigateBeforeIcon />
            </button>
