...
export function groupSumByBrand(data: SalesByBrand[]): { brand: string; value: number }[] {
  const groupedData = data.reduce((acc: Record<string, { brand: string; value: number }>, sales) => {
