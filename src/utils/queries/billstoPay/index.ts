...
export const billsToPayQueries = ({
  ...
  '2022-12-01' AND CURRENT_DATE AND pgm.status_pgm IN (1, 4))OR (pgm.datahora_pagamento_pgm BETWEEN DATE '${dateInit}' AND DATE '${dateEnd}' AND pgm.status_pgm = 2) ) AND pgm.id_emp IN (1, 2, 3, 4, 5, 100) ORDER BY 
