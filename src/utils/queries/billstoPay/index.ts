...
export const billsToPayQueries = ({
  ...
  BETWEEN '2022-12-01' AND CURRENT_DATE  AND pgm.status_pgm IN (1, 4)) OR  (pgm.datahora_pagamento_pgm BETWEEN DATE '${dateInit}' AND DATE '${dateEnd}'  AND pgm.status_pgm IN (2, 4))) AND pgm.id_emp IN (1, 2, 3, 4, 5, 100)
  GROUP BY  pgm.id_pgm, pgm.status_pgm, pgm.data_vencimento_pgm, pgm.valor_pgm, pgm.VALOR_PAGO_PGM, pgm.numero_documento_pgm, pgm.id_grc, pgm.descricao_grc, pgm.nome_pss, pgm.id_cnt, pgm.descricao_cnt ORDER BY 
