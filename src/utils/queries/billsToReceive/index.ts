...
export const billsToReceiveQueries = ({
  ...
  let billsToReceiveAll = `select a.id_rcb, a.id_origem as ID_SDS, a.data_vencimento_rcb, rci.DATA_RECEBIMENTO_RCI, a.valor_rcb, a.restante_rcb, a.VALOR_PAGO_RCB, a.id_pss || ' - ' || a.apelido_pss as 
