  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      <motion.div
        ...
        className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-xl w-full text-center p-8 space-y-6"
      >
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="md:text-lg xl:text-xl text-gray-500 mt-4">Ops! Algo deu errado nos nossos servidores.</p>
        </div>
